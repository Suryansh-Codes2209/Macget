...
export function SectionHeading({
  ...
  return (
    ...
    >
      ...
      <h2 className="text-balance text-4xl font-semibold leading-[1.05] tracking-tight text-frost sm:text-5xl">
        {title}
      </h2>
      {lede && (
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-frost-dim sm:text-lg">
          {lede}
        </p>
      )}
    </div>
