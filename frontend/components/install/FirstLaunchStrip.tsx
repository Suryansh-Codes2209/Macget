    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <SectionHeading
          ...
          lede={
            <>
              MacGet is free and <strong className="text-cream">not notarized</strong> —
        ...
        <MotionInView className="mt-14 grid gap-5 md:grid-cols-3">
          {siteConfig.firstLaunch.map((step, i) => (
            ...
            >
              <div className="mb-5 inline-flex size-9 items-center justify-center rounded-xl border border-line bg-white/[0.04] font-mono text-sm text-brand-honey">
                {i + 1}
              </div>
        ...
        <div className="mt-8 flex flex-col gap-4 rounded-tile border border-line bg-surface/40 p-7 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-3">
            <ShieldAlert className="mt-0.5 size-5 shrink-0 text-brand-honey" />
            <div>
              ...
              <code className="mt-3 block overflow-x-auto rounded-xl border border-line bg-abyss px-4 py-3 font-mono text-xs text-cream-dim">
          ...
          <Link
            href="/install"
            className="shrink-0 rounded-pill border border-line bg-white/[0.04] px-5 py-2.5 text-sm text-cream transition-colors hover:border-white/20 hover:bg-white/[0.08]"
          >
            Full install guide
          </Link>
        </div>
